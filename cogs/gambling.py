...
class Gambling(commands.Cog):
    ...
    async def coinflip(self, ctx, amount: int, choice: str = "h"):
     ...
     if choice == result:
         delta = amount
         result_text = f"🎉 You **WON {amount:,} {CURRENCY}**!"
         color = discord.Color.green()
     else:
         delta = -amount
     ...
     embed.set_footer(text="Moonlight Economy • Flip responsibly 🌙")
